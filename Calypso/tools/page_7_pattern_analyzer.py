...
Focus: Chapter 1, Page 7 (second page of first numbered chapter)
"""
...
def main():
    ...
    output_dir = "../analysis"
    page_num = 7  # Second page of Chapter 1
    ...
    # Save analysis
    analysis_file = os.path.join(output_dir, "page_7_pattern_analysis.json")
